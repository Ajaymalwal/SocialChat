            ...
            <div className='section2-1'>
                <div className='about1'>
                 ...
                 <div className='about2'>
                     <p>Welcome to our real-time chat app! We're a passionate team of three students dedicated to creating seamless communication experiences. With a focus on user-friendly design and reliable performance,
                         we aim to connect people worldwide. Our app prioritizes privacy and security while fostering meaningful connections. Join us in shaping the future of instant messaging!</p></div>
